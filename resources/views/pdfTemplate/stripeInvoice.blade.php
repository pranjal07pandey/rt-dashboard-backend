...
<table border="0" cellpadding="0" cellspacing="0" class="body">
    <tr>
        <td class="container">
            <div class="content">
                <center>
                    <div style="width:80px;height:80px;border-radius:40px;-webkit-border-radius:40px;-moz-border-radius: 40px; background:#003358;overflow:hidden;margin:0px auto 5px;">
                        <img src="https://files.stripe.com/files/f_live_AV2RAgQYWSgqO1Try5UjQuhZ" width="100%">
                    </div>
                </center>
                <div style="line-height:1.5;text-align:center;color:#636b6f;margin-top:5px;">
                    <strong style="font-size: 22px;  margin-top: 0px;margin-bottom: 0px;text-transform: uppercase;font-weight: 500;color: #2b2d50;">RECORD TIME PTY LTD.</strong>
                    ...
                    <tr>
                        <td class="wrapper">
                            <table border="0" cellspacing="0" >
                                <thead>
                                <tr style="padding:10px; background:#0c3355;text-align:left;color: #fff;text-transform:uppercase;">
                                    <th>Description</th>
                                    <th>QTY</th>
                ...
                <img src="https://www.recordtimeapp.com.au/backend/assets/dashboard/images/stripeLogo.png" width="45px" style="margin-bottom: -2px;margin-left: 7px;">
