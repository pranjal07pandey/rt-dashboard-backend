                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                                        ...
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            {{ $first_name }} {{$last_name}} updated his/her profile. Details are:<br>
                                            <strong>Email: </strong> <span>{{$email}}</span><br>
                                            <strong>Full Name: </strong> <span>{{ $first_name }} {{$last_name}}</span><br>
                                            <strong>Company Name: </strong> <span>{{$company_name}}</span><br>
                                            <strong>Abn: </strong> <span>{{$abn}}</span><br>
                                            <strong>Contact Number: </strong> <span>{{$contact_number}}</span><br>
