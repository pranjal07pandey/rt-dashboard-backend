                                ...
                                <tr>
                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                                        ...
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            You are receiving this email because your employer has made an account for you on Record Time, digital docketing application.
                                        </p>
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            Please download the application for iOS or Android to get started.
                                        </p>
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                        ...
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            Please visit <a href="recordtime.com.au" target="_blank">recordtime.com.au</a> for more details
                                        </p>
                                    </td>
                                </tr>
                            </table>
