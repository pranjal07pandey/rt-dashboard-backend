...
<head>
    ...
    <title>Cancel Subscription Record Time</title>
    <style type="text/css">
        /* -------------------------------------
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                                <tr>
                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">We are sorry to hear that you have decided to cancel your Record Time subscription.</p>
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">We would really love to have you back, so you can receive the full benefits of Record Time. </p>
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            <a href="{{ url('redirect/'.\Illuminate\Support\Facades\Crypt::encryptString(url('dashboard/company/profile/continueSubscription'))) }}" target="_blank"  style="text-decoration:none;background: #003f67;color: #fff;padding: 10px 20px;border-radius: 5px;">Click here to reactivate subscription</a>
                                        </p>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                        <tr>
                            <td class="content-block" style="font-family:sans-serif;font-size:14px;vertical-align:top;color:#999999;font-size:12px;text-align:center;">
                                <span class="apple-link" style="font-weight:bold;color:#999999;font-size:12px;text-align:center;">Download the Record Time App</span>
                                <br/>
