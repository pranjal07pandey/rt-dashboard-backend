...
<head>
    ...
    <title>Trial Subscription Continue Notification</title>
    <style type="text/css">
        /* -------------------------------------
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                                <tr>
                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">Thank you for trialing Record Time. </p>
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            Your trial of {{ $plan }} has been activated.
                                        </p>
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            Please update your credit card details to avoid interruptions after the trial ends.
                                        </p>

                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            <a href="{{ url('redirect/'.\Illuminate\Support\Facades\Crypt::encryptString(url('dashboard/company/profile/updateCreditCard'))) }}" target="_blank" style="text-decoration:none;background: #003f67;color: #fff;padding: 10px 20px;border-radius: 5px;">Click here to update your credit card</a>
                                        </p>
