...
<head>
    ...
    <title>New Subscription Record Time</title>
    <style type="text/css">
        /* -------------------------------------
                                ...
                                <tr>
                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                                        ...
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            Record Time allows you send, receive, and approve dockets between other users and employees, or emailed to anyone.
                                        </p>
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            <a href="recordtime.com.au" target="_blank">Click here to upgrade your Plan</a>
                                        </p>
