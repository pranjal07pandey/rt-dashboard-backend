...
<head>
    ...
    <title>Subscription Downgrade Notification</title>
    <style type="text/css">
        /* -------------------------------------
                                ...
                                <tr>
                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                                        ...
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            We are sorry to hear that you have downgraded your Record Time plan to a {{ $plan->max_user }} user plan. You will now have access to the following features:
                                        </p>
                                        <ul>
                                            @if($plan->description)
                                                @foreach($plan->description as $row)
