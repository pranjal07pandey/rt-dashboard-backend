...
<head>
    ...
    <title>Subscribe Record Time</title>
    <style type="text/css">
        /* -------------------------------------
                                ...
                                <tr>
                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                                        ...
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            Your 30 days trial of X Plan (for eg: 1 User Plan) has been activated.
                                        </p>
                                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px;">
                                            <a href="http://recordtime.com.au" target="_blank">Click here to upgrade your Plan</a>
                                        </p>
