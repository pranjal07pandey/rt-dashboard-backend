                ...
                <table class="main" style="border:1px solid #ddd; padding-bottom: 15px;padding-top: 15px;border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;background:#fff;border-radius:3px;width:100%;">
                    ...
                    <tr>
                        ...
                        <td style="font-family:sans-serif;font-size:14px;vertical-align:top;"><br/>
                            <strong>Hi {{ $user->email }},</strong><br/><br/>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                                <tr>
                                    <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;width:auto;">
                                                        ...
                                                        <tr>
                                                            <td style="text-align: center;font-family:sans-serif;font-size:14px;vertical-align:top;background-color:#ffffff;border-radius:5px;text-align:center;background-color:#3498db;">
                                                                <a href="{{ url('/email_verification/'.$user->email_verification) }}" target="_blank" style="text-decoration:underline;background-color:#ffffff;border:solid 1px #3498db;border-radius:5px;box-sizing:border-box;color:#3498db;cursor:pointer;display:inline-block;font-size:14px;font-weight:bold;margin:0;padding:10px 25px;text-decoration:none;text-transform:capitalize;background-color:#3498db;border-color:#3498db;color:#ffffff;">
                                        ...
                                        <hr/>
                                        <small>If you’re having trouble clicking the "Click here to verify" button, copy and paste the URL below into your web browser:
                                            <a href="{{ url('/email_verification/'.$user->email_verification) }}" style="word-break: break-all;">{{ url('/email_verification/'.$user->email_verification) }}</a>
                                        </small>
                                    </td>
                                </tr>
                            </table>
