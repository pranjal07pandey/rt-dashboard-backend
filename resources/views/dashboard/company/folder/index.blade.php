...
<head>
    ...
    <meta content="jsFiler" name="generator">
    <title>jsFiler</title>
    <link type="image/x-icon" rel="shortcut icon" href="favicon.ico">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jstree/3.3.5/themes/default/style.min.css" />
    <link media="all" type="text/css" rel="stylesheet" href="{{asset('assets/folder/jsfiler.min.css')}}">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jstree/3.3.5/jstree.min.js"></script>
    <script src="{{asset('assets/folder/jsfiler.js')}}" type="text/javascript"></script>
</head>
<style type="text/css">
    body {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        /* create the tree */
        $('#filer_0').jsfiler({menuMode: menu.mode, mainMenu: menu.main, checkBox: 0,
            ...
            userAuth: null,
            /* ajax request url */
            urlAjax: '{{ url('/dashboard/company/folder/ajax') }}',
        });  //activate
