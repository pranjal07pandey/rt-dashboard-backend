            ...
            <div class="col-md-9">
                <div class="viewFolder" style="padding-left: 0;     min-height: 529px;background: #fbfbfb;">
                    <div class="rtTabHeader">
                        <ul>
                            <li><h4 style="    margin: 17px 0px 17px 17px;font-size: 17px;font-weight: 500;color: #3a3a3a;">Sent Invoices</h4></li>
                            ...
                            @if(count(@$sentInvoice)==0)
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" class="text-right">
                                        @if(@$searchKey)
                                            {{ $sentInvoice->appends(['search'=>$searchKey,'items'=>$items])->links() }}
                                        @else
                                            {{ $sentInvoice->appends(['items'=>$items]) ->links() }}
                                        @endif
                                    </td>
                                </tr>
                                </tfoot>
