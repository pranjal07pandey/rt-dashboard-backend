...
@section('content')
    <section class="content-header rt-content-header">
        ...
        <ol class="breadcrumb hidden-sm hidden-xs">
            <li><a href="{{ route('invoices.allInvoices') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    ...
    <div class="modal fade" id="cantSynToXero" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;">
        <div id="second"  class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header themeSecondaryBg">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i>&nbsp;Cannnot syn Invoice</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <p><i class="fa fa-exclamation-circle"></i> Please create  a Custom Client.</p>
                        </div>
    ...
    <style>
        ...
        {{--background-image: url({{asset('assets/folder/icons/32px.png')}}) !important;--}}
        {{--}--}}
    </style>
@endsection
