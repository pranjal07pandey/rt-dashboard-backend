...
@section('content')
            ...
            <div class="col-md-9">
                <div class="viewFolder" style="padding-left: 0;     min-height: 529px;background: #fbfbfb;">
                    ...
                    <div class="rtTabHeader">
                        <ul>
                            <li><h4 style="    margin: 17px 0px 17px 17px;font-size: 17px;font-weight: 500;color: #3a3a3a;">Received Invoices</h4></li>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td colspan="5" class="text-right">
                                        @if(@$searchKey) {{ $receivedInvoice->appends(['search'=>$searchKey,'items'=>$items])->links() }}
    ...
    <br>
    @php $filterType    =   "received"; @endphp
