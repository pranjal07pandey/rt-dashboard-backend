...
@section('content')
    ...
    <div class="boxContent">
        ...
        <div class="boxBody" style="padding:0px 15px 15px;">
            {{ Form::open(['route' => array('employees.admin.update',$user), 'method'=> 'patch']) }}
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group label-floating">
                        <label class="control-label" for="title">First Name</label>
                        <input type="text" name="firstName" class="form-control" required="required" value="{!! $user->first_name !!}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group label-floating">
                        <label class="control-label" for="title">Last Name</label>
                        <input type="text" name="lastName" class="form-control" required="required" value="{!! $user->last_name !!}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group label-floating">
                        <label class="control-label" required for="email">Email</label>
                        <input type="email" required="required" class="form-control" name="email" value="{!! $user->email !!}" disabled="disabled">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group ">
                                <center>
                                    <a href="{{ AmazoneBucket::url() }}{{ $user->image }}" target="_blank">
                                        <img src="{{ AmazoneBucket::url() }}{{ $user->image }}" height="32px">
                ...
                <div class="col-md-4">
                    <div class="form-group" >
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="1" name="admin" checked disabled="disabled"> Admin?
                            </label>
                ...
                <div class="col-md-4">
                    <div class="form-group" >
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="1" name="employed" checked disabled="disabled">  Currently Employed?
                            </label>
                ...
                <div class="col-md-4">
                    <div class="form-group" >
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="1" name="appearOnRecipient" @if($company->appear_on_recipient==1) checked @endif>  Appear as Recipient?
                            </label>
                ...
                <div class="col-md-4">
                    <div class="form-group" >
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="1" name="docket" @if($company->can_docket==1) checked @endif>  Can Docket?
                            </label>
                ...
                <div class="col-md-4">
                    <div class="form-group" >
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="1" name="canSelfDocket" @if($company->can_self_docket==1) checked @endif>  Can Self Docket?
                            </label>
                ...
                <div class="col-md-4">
                    <div class="form-group" >
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="1" name="docket_client" @if($company->docket_client==1) checked @endif> Docket Client?
                            </label>
                ...
                <div class="col-md-4">
                    <div class="form-group" >
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="1" name="invoice"  @if($company->can_invoice==1) checked @endif> Can Invoice?
                            </label>
                ...
                <div class="col-md-4">
                    <div class="form-group" >
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" value="1" name="timer" @if($company->can_timer==1) checked @endif>  Can Timer?
                            </label>
            ...
            <div class="box-footer" style="padding: 0px;">
                ...
                <button type="submit" class="btn btn-xs btn-raised btn-info pull-right"><i class="fa fa-check"></i> Submit</button>
            </div>
