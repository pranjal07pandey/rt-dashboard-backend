            ...
            <div  class="formElement" style="margin-bottom:0px;">
                ...
                <div>
                    ...
                    <div style="float: right">
                        <button type="submit" class="btn btn-primary"  data-toggle="modal" data-target="#addNewParentPrefillermodel" data-docketFieldId="{{$docketFielddata->id}}" data-is_dependent="{{$docketFielddata->is_dependent}}"  data-docket_id="{{$docketFielddata->docket_id}}" style="background: #03A9F4;color: #ffffff;padding: 2px 16px; border-radius: 2px;margin: 0 10px 22px 0px;font-size: 12px;">Add</button>
                        <button type="submit" class="btn btn-danger" id="clearAllPrefiller" docketFieldId="{{$docketFielddata->id}}" style="background: #f44336;color: #ffffff;padding: 2px 16px;  border-radius: 2px;    margin: 0 10px 22px 0px; font-size: 12px;"> Clear All</button>
                    </div>
                    <div class="clearfix"></div>
                </div>
