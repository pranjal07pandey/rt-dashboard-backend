            ...
            <div class="col-md-9 " style="padding-left: 0;">
                <div class="viewFolder" style="padding-left: 0;     min-height: 529px;background: #fbfbfb;">
                    <div class="rtTabHeader">
                        <ul>
                            <li><h4 style="    margin: 17px 0px 17px 17px;font-size: 17px;font-weight: 500;color: #3a3a3a;">Received Dockets</h4></li>
                    ...
                    <div class="rtTabContent">
                        ...
                        <table class="rtDataTable datatable" >
                            ...
                            @if(count(@$sentDockets)==0)
                                <tr><td colspan="7"><center>Data Empty</center></td></tr>
                            @endif
                            </tbody>
                            <tfoot>
                            <tr>
                                <td colspan="3">
                                    <span>Showing {{ $sentDockets->firstItem() }} to {{ $sentDockets->lastItem() }} of {{ $sentDockets->total() }} entries</span>
                                </td>
