            ...
            <div class="col-md-9 " style="padding-left: 0;">
                <div class="viewFolder" style="padding-left: 0;     min-height: 529px;background: #ffffff;">
                    ...
                    <div class="rtTabHeader">
                        <ul>
                            <li><h4 style="    margin: 17px 0px 17px 17px;font-size: 17px;font-weight: 500;color: #3a3a3a;">All Dockets</h4></li>
...
@section('customScript')
    ...
    {{-- <script src="{{  asset('V2') }}"></script> --}}
       ...
       <link rel="stylesheet" type="text/css" href="{{ asset('assets/folder/v2/rtTree.css') }}"/>
