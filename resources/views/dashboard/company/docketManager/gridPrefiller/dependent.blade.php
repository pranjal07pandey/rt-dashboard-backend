        ...
        <div class="col-md-12">
            ...
            <div  class="formElement" style="margin-bottom:0px;">
                ...
                <div class="col-md-12">
                        ...
                        <select class="form-control saveDocketPrefillerManager" style="margin: 16px 4px 22px -15px;">
                            <option value="0" @if($docketGridField->docket_prefiller_id == 0)selected @endif>None</option>
                            @foreach($docketPrefillerManager as $data)
                                <option value="{{$data->id}}" isInteger="{{ $data->is_integer }}" datatype="{{$data->type}}" @if($docketGridField->docket_prefiller_id == $data->id)selected @endif>{{$data->title}}</option>
                            @endforeach
                        </select>
                ...
                <div>
                    ...
                    <div style="float: right">
                        <input style="    float: left;margin-right: 12px;" type="checkbox" class="cellAutoFill" gridId="{{ $docketGridField->id }}" @if($docketGridField->auto_field == 1) checked @endif value="0" >
                ...
                <div class="setGridPrefillers scrolling-pagination" style="    height: 294px;overflow-y: auto; overflow-x: auto;width: 99%;    margin-top: 16px;">
                    @if(@$finalPrefillerView)

                        @if($docketGridField->docket_prefiller_id == 0)
                        ...
                        <div id="prefillerValueWrapper{{ $docketGridField->id }} "    >
                                <table style="overflow-x: auto;white-space: nowrap;padding-bottom: 15px; overflow-y: hidden; margin-bottom: 10px;" class="prefillerpaginateData" >
                                       <tr  @if($docketGridField->auto_field == 1) style="background: #E9ECEF;height: 61px;     border: 1px solid #CED4DA;" @else style="height: 61px; background: #E9ECEF;    border: 1px solid #CED4DA; display: none" @endif >
                                           <td style="font-size: 14px;color: #000000;font-weight: 500; ">  <div style="width: 150px;">{!! @$docketGridField->label !!}</div></td>
                                           @for($x = 0; $x < $finalPrefilMaxIndex; $x++)
                                               <?php
