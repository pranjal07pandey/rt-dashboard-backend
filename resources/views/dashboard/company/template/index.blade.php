    ...
    <div class="container">
      <main>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                @if($sentInvoiceValue)
                    @foreach($sentInvoiceValue as $item)
                        @if($item["invoice_field_category_id"]!=9 && $item["invoice_field_category_id"]!=12 && $item["invoice_field_category_id"]!=5)
                            {{--<tr>--}}
                                {{--<td class="desc" style="    background: #DDDDDD;">--}}
                            ...
                            <tr>
                                ...
                                <td class="desc" style="    background: #DDDDDD;"><h3><strong>{{ $item["label"] }}</strong></h3></td>
                                <td class="total">{{ $item["value"] }}</td>
                            </tr>
                ...
                <tr>
                    <td class="no" ><?php echo $i++ ?></td>
                    <td class="desc" style="    background: #DDDDDD;"><h3>Subtotal</h3></td>
                    <td class="total">${{ round($sentInvoice->amount,2) }}</td>

                </tr>
                <tr>
                    <td class="no"><?php echo $i++ ?></td>
                    <td class="desc" style="    background: #DDDDDD;"><h3>{{ $sentInvoice->invoiceInfo->gst_label }}</h3></td>
                    <td class="total">{{ $sentInvoice->gst }} %</td>

                </tr>
                <tr>
                    <td class="no"><?php echo $i++ ?></td>
                    <td class="desc" style="    background: #DDDDDD;"><h3>Total</h3></td>
                    <td class="total">$
            ...
            {{--<div class="notice signature-doct"><img src="signature.png" style="height: 30px;"></div>--}}
            {{--</div>--}}
            @if($invoiceSetting)
                <div id="next-docket">
                    <table border="0" cellspacing="0" cellpadding="0">
          ...
          <div id="notices " class="information">
            ...
            @endif
            <div id="images">
                <div class="img-title"><h2>Attached Images</h2></div>
                <div class="img-box-titiled">
        ...
        <main class="doc-part">
            ...
            <header class="clearfix headerInvoice">
                {{--<div id="logo">--}}
                    {{--<img src="{{asset($row->docketInfo->senderCompanyInfo->logo)}}" style="height: 80px;">--}}
                {{--</div>--}}
                <div id="company">
