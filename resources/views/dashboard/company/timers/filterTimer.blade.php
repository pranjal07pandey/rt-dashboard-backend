                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group" style="margin-top:0px;">
                                                <input type="date" class="form-control " dateType="docketCreated"  name="from"  placeholder="From"  value="{{$request->from}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group" style="margin-top:0px;">
                                                <input type="date" class="form-control" dateType="docketCreated"  value="{{$request->to}}" name="to" placeholder="To" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group" style="margin-top:0px;">
                                                {{--<input type="hidden" value="@foreach($request->client as $row){{ @App\User::where('id',$row)->first()->first_name }},@endforeach" id="clientNamess">--}}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group" style="margin-top:0px;">
                                                <input type="text" id="range_08" name="duration" value="{{$request->duration}}"   />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('customScript')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var clientNam=$('#clientNamess').val();
