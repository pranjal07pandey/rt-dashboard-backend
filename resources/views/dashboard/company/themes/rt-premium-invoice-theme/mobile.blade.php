    ...
    <div class="row" style="padding-top: 15px;background: #fff;margin: 0px;min-height: 400px;">
    	<div class="col-md-12">
            <div id="printContainer">
            	<div class="division-one" style="min-height: 112px;">
			      ...
			      <div class="tax-invoice">
			        <h1 style="font-size:14px;">TAX INVOICE</h1>
			      </div>
			      <div class="division-logo">
			        <ul style="font-size:12px;">
			          ...
			          <li >Phone: {{ @$invoice->senderCompanyInfo->contactNumber }} </li>
			        </ul>
			      </div>
			    </div>
			    <div class="division-two">
			    	<div class="invoice-fm">
				        <ul style="font-size:12px;">
				          ...
				          <li>M:{{ @$invoice->senderUserInfo->email }} </li>
				        </ul>
				    </div>
			 	...
			 	<div class="amount-value">
			 		<table cellpadding="0" class="amount-table" style="font-size:12px;">
			 			<thead>
				            <tr class="">
			 	...
			 	<div class="payment-right">
			 		<table class="right-table" style="font-size:12px;">
			 			<tbody>
				            <tr>
				              <td>Sub Total</td>
				              <td class="total-right bold-left"> {{ round($invoice->amount,2) }}</td>
				            </tr>
				            <tr>
				              <td>{{ $invoice->invoiceInfo->gst_label }}</td>
				              <td class="total-right bold-left">{{ $invoice->gst }}%</td>
				            </tr>
			 		...
			 		@if($sentInvoiceValue)
				 		@foreach($sentInvoiceValue as $item)
			    			@if($item["invoice_field_category_id"]==9)
						    	<div class="verified-by" style="font-size:12px;">
						          <p>{{ $item["label"] }}</p>
			 	...
			 	@if($sentInvoiceValue)
				 	<div class="proof-work" style="font-size:12px;">
					  @foreach($sentInvoiceValue as $item)
