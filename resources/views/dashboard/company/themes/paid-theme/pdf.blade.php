                ...
                <div class="division-one">
                    <div class="invoice-from">
                        @if(AmazoneBucket::fileExist(@$sentInvoice->senderCompanyInfo->logo))
                            <img style="width:150px;" src="{{ AmazoneBucket::url() }}{{ @$sentInvoice->senderCompanyInfo->logo }}">
                        @else
                            <img style="width:150px;"
                                 src="https://dummyimage.com/100x100/f0f0f0/ffffff.jpg&text=your+logo">
                        @endif
                        <ul>
                    ...
                    <div class="division-logo">
                        <ul>
                            <li class="bold-d">{{ @$sentInvoice->senderCompanyInfo->name }}</li>
                            <li class="deam">{{ @$sentInvoice->senderCompanyInfo->address }}</li>
                            <li class="deam">ABN:{{ @$sentInvoice->senderCompanyInfo->abn }}</li>
                            <li class="deam"><i class="fa fa-phone"
                                                aria-hidden="true"></i>&nbsp;{{ @$sentInvoice->senderCompanyInfo->contactNumber }}
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="division-o">
                    ...
                    <div class="invoice-tax">
                        <div class="tax-invoice">
                            <p class="bold-d tax-bold">TAX INVOICE</p>
                            <div class="invoice-date">
                                <ul>
                                    <li><b>Invoice ID:</b><span>{{ $sentInvoice->id }}</span></li>
                                    <li>
                                        <b>Date:</b><span>{{ \Carbon\Carbon::parse($sentInvoice->created_at)->format('d-M-Y') }}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <table class="right-table">
                        ...
                        <tr>
                            ...
                            <td class="total-right bold-d">
                                $ {{ round($sentInvoice->amount*$sentInvoice->gst/100,2)  }}</td>
                        </tr>
                        ...
                        <div class="division-one-e">
                            ...
                            <div class="invoice-fromm">
                                @if(AmazoneBucket::fileExist(@$sentInvoice->senderCompanyInfo->logo))
                                    <img style="width:150px;" src="{{ AmazoneBucket::url() }}{{ @$sentInvoice->senderCompanyInfo->logo }}">
                                @else
                                    <img style="width:150px;" src="https://dummyimage.com/100x100/f0f0f0/ffffff.jpg&text=your+logo">
                                @endif
                                <ul>
                                    <li class="deam">From:</li>
                            ...
                            <div class="division-logoo">
                                <ul>
                                    ...
                                    <li class="deam"><i class="fa fa-phone" aria-hidden="true"></i>&nbsp;{{  $row->docketInfo->senderCompanyInfo->contactNumber  }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="tax-invoice">
                                    ...
                                    <div class="invoice-date">
                                        <ul>
                                            ...
                                            <li>
                                                <b>Date:</b><span>{{ \Carbon\Carbon::parse($row->docketInfo->created_at)->format('d-M-Y') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                                        ...
                                                                        <a href="{{ AmazoneBucket::url() }}{{ $document->url }}"
                                                                           target="_blank">
                                                                            <i class="fa fa-file-text"
                                                                               aria-hidden="true"></i>&nbsp;<span>{{$document->document_name}}</span>
                                                                        </a>
                                                                    </li>
                                                                @endforeach
                                                            </ul>
