...
<div class="isvoiceabledocket">
    ...
    @if(count($rangeandDocketTemplate)!=0)
        ...
        <input type="hidden" id="submitURL" value="{{url('dashboard/company/sentInvoice/filterInvoiceableEmailDocket')}}">
    ...
    <strong>Email Dockets</strong>
    <br>
    <br>
    <div class="row" style="    height: 540px;overflow-x: auto; position: relative">
        <input type='hidden' class="invoiceableDocketType" value ="2">

        <div id="filterEmailDocketAttacheable">
