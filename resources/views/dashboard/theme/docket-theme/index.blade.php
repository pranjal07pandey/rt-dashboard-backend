      ...
      <div id="printContainer">
        <div class="docket-box">
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td style="border-top: none !important; padding: 0px;">
                <ul class="list-unstyled">
                  ...
                  <li class="web-app"><b>{{ @$sentDocket->company_name }}</b></li>
              ...
              <td style="border-top: none !important; padding: 0px;">
                <ul class="list-unstyled pull-right">
                  ...
                  <li><b>Date</b>: {{ \Carbon\Carbon::parse($sentDocket->created_at)->format('d-M-Y') }}</li>
                  <li><b>Docket ID</b>: {{ $sentDocket->id }}</li>
                  <li><b>ABN</b>: {{ @$sentDocket->abn }}</li>
                </ul>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td clearfix>
                <ul class="list-unstyled clearfix pull-right text-right">
                  <li>To:</li>
