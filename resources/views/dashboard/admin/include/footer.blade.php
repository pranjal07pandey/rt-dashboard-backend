    ...
    @else
        ...
        <?php
        $xeroUserDetail1 = \App\CompanyXero::where('company_id', Session::get('company_id'));
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-5 text-center">
                <div>
                    <a href="https://itunes.apple.com/au/app/record-time/id971035780?mt=8" target="_blank" title="Apple Store Download Link" class="pull-left"><img src="{{ asset('assets/dashboard/img/iOSBadge.png') }}" alt="Download Record Time for iPhone Devices">
                    </a>
                    <a href="https://play.google.com/store/apps/details?id=com.webtecsolutions.recordtimeapp" target="_blank"  class="pull-left" style="margin-left:10px;" title="Google Play Store Download Link"><img src="{{ asset('assets/dashboard/img/androidBadge.png') }}" alt="Download Record Time for Android Devices">
                    </a>
                </div>
            </div>
        </div>
        ...
        <p class="navbar-text" style="font-size:12px;margin-top:0px;margin-left: 0px;">© 2015 - 2018 Record TIME Pty Ltd. All rights reserved. ABN: 99 604 582 649 | Unit 5, 9 Beaconsfield Street Fyshwick ACT 2609 AUSTRALIA | Support: 0421 955 630
        </p>
        ...
        <div id="second"  class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header themeSecondaryBg">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i>&nbsp;Xero Connection Expire</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" id="docketdelete_label_id" name="id">
                            <p> <i class="fa fa-exclamation-circle"></i>  Xero Connection Expired Please connect to xero.</p>
                        </div>
                    </div>
                </div>
            </div>
