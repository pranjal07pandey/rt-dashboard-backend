...
class CreateEmailSentDocketTallyUnitRateValsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('email_sent_docket_tally_unit_rate_vals', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('email_sent_docket_tally_unit_rate_vals');
    }
}
