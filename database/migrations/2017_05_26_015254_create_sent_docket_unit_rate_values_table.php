...
class CreateSentDocketUnitRateValuesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sent_docket_unit_rate_values', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sent_docket_unit_rate_values');
    }
}
