...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		 ...
		 * previous, first or last mainCategory.
	 ...
	 *  * `mainCategory` - Total number of mainCategory
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} mainCategory` The number of mainCategory in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, mainCategory ) {
