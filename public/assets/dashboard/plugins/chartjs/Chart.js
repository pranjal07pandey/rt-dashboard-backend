	...
	var each = helpers.each = function(loopable,callback,self){
		...
		calculateScaleRange = helpers.calculateScaleRange = function(valuesArray, drawingSize, textSize, startFromZero, integersOnly){
			...
			if (maxValue === minValue){
				maxValue += 0.5;
				// So we don't end up with a graph with a negative start value if we've said always start from xero
...
(function(){
	...
	var defaultConfig = {
		//Boolean - Whether the scale should start at xero, or an order of magnitude down from the lowest value
