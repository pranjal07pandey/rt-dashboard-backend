...
$(document).ready(function(){
    ...
    (function( bootstro, $, undefined ) {
        ...
        var defaults = {
            ...
            finishButtonText : '<i class="icon-ok"></i> Skip',
        ...
        function add_nav_btn(content, i)
        {
            ...
            {
                nextButton = '<button class="test ' + defaultBtnClass + ' bootstro-next-btn">' + $el.attr('data-bootstro-nextButtonText') +  '</button>';
            }
            else 
            {
                if (typeof settings.nextButton != 'undefined' /*&& settings.nextButton != ''*/)
                    ...
                    if($el.attr('data-target')!=""){
                        nextButton = '<button  data-target="' + $el.attr('data-target') + '" class="' + defaultBtnClass + ' bootstro-next-btn">' + settings.nextButtonText + '</button>';
            ...
            else 
            {
                if (typeof settings.prevButton != 'undefined' /*&& settings.prevButton != ''*/)
                    ...
                    if($el.attr('data-target')!=""){
                        prevButton = '<button data-target="' + $el.attr('data-target') + '" class="' + defaultBtnClass + ' bootstro-prev-btn">' + settings.prevButtonText + '</button>';
            ...
            {
                finishButton = '<button class="' + defaultBtnClass +' bootstro-finish-btn zipFile">' + $el.attr('data-bootstro-finishButtonText') +  '</button>';
            }
            else 
            {
                if (typeof settings.finishButton != 'undefined' /*&& settings.finishButton != ''*/)
                    ...
                    if($el.attr('data-target')!=""){
                        finishButton = '<button data-target="' + $el.attr('data-target') + '" class="' + defaultBtnClass + ' bootstro-finish-btn zipFile">' + settings.finishButtonText + '</button>';

                    }else{
                        finishButton = '<button class="' + defaultBtnClass +' bootstro-finish-btn zipFile">' + settings.finishButtonText + '</button>';
            ...
            content = content +finishButton + '</div>';
            return content;
        }
